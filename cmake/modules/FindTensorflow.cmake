...
if(scram_path)
    ...
    set(Tensorflow_LIBRARIES "${Tensorflow_LIBRARY_DIRS}/libtensorflow_cc")
    ...
    list(APPEND Tensorflow_LIBRARIES "${CMAKE_MATCH_1}/libtensorflow")
    ...
    string(REGEX MATCH "\nLIBDIR=([^\n]*)" PB_STR ${SCRAM_PB_INFO})
    list(APPEND Tensorflow_LIBRARY_DIRS ${CMAKE_MATCH_1})
    list(APPEND Tensorflow_LIBRARIES "${CMAKE_MATCH_1}/libprotobuf")
